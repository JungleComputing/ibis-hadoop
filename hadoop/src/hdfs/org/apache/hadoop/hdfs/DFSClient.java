...
public class DFSClient implements FSConstants, java.io.Closeable {
	...
	public static ClientProtocol createNamenode(VirtualSocketAddress nameNodeAddr,
	...
	private static ClientProtocol createRPCNamenode(
			VirtualSocketAddress nameNodeAddr, Configuration conf,
	...
	static ClientDatanodeProtocol createClientDatanodeProtocolProxy(
		...
		VirtualSocketAddress addr = datanodeid.getVirtualSocketAddress();
	 ...
	 */
	public DFSClient(VirtualSocketAddress nameNodeAddr, Configuration conf)
			throws IOException {
	 ...
	 */
	DFSClient(VirtualSocketAddress nameNodeAddr, ClientProtocol rpcNamenode,
   ...
   */
	...
	MD5MD5CRC32FileChecksum getFileChecksum(String src) throws IOException {
		checkOpen();
		return getFileChecksum(src, namenode, socketTimeout);
	}
