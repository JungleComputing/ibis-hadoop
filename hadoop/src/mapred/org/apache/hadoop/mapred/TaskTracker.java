...
public class TaskTracker implements MRConstants, TaskUmbilicalProtocol,
	...
	public static int VIRTUAL_PORT = 5855;
	...
	VirtualSocketAddress jobTrackAddr;

	VirtualSocketAddress taskReportAddress;
	...
	synchronized void initialize() throws IOException {
		...
		// duration
		// of a heartbeat RPC
		this.taskReportServer = RPC.getServer(this, VIRTUAL_PORT, 2 * max,
				false, this.fConf);
		this.taskReportServer.start();

		this.fConf.set("mapred.task.tracker.report.address", this.taskReportAddress.toString());
	...
	public synchronized VirtualSocketAddress getTaskTrackerReportAddress() {
