 ...
 * @see Client
 */
public abstract class CopyOfServer {
	...
	public static final Log LOG = LogFactory.getLog(CopyOfServer.class);

	private static final ThreadLocal<CopyOfServer> SERVER = new ThreadLocal<CopyOfServer>();
	 ...
	 * the server context.
	 */
	public static CopyOfServer get() {
		return SERVER.get();
	}
	...
	protected CopyOfServer(String bindAddress, int port,
