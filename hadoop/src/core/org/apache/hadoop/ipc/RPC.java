...
public class RPC {
	...
	static private class ClientCache {
		private Map<VirtualSocketFactory, Client> clients = new HashMap<VirtualSocketFactory, Client>();
		 ...
		 * @return an IPC client
		 * @throws IOException
		 *             if a socketfactory could not be found/created
		 */
		private synchronized Client getClient(Configuration conf)
				throws IOException {
			try {
				return getClient(conf, VirtualSocketFactory
	...
	static VersionedProtocol waitForProxy(Class protocol, long clientVersion,
			VirtualSocketAddress addr, Configuration conf, long timeout)
			throws IOException {
	...
	public static Object[] call(Method method, Object[][] params,
			VirtualSocketAddress[] addrs, Configuration conf)
			throws IOException {
	...
	/** Expert: Make multiple, parallel calls to a set of servers. */
	public static Object[] call(Method method, Object[][] params,
			VirtualSocketAddress[] addrs, UserGroupInformation ticket,
